...
function foodbakery_frame_createpop(data, type, thisID) {
    "use strict";
    
    
    var section_index = jQuery(".section_id_"+thisID).index('.foodbakery-section-block');
    jQuery(".section_id_"+thisID).data('index_id', section_index);
    
    
    //console.log(jQuery(".section_id_"+thisID).data('index_id'));
