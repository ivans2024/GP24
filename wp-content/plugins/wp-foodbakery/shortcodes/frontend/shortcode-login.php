    ...
    class Foodbakery_Shortcode_Login_Frontend {
        ...
        public function foodbakery_registration_tab() {
            ...
            if ($isRegistrationOn) {
                ...
                $_SESSION['current_url'] = home_url($_SERVER['REQUEST_URI']);
                $output_html .= apply_filters('foodbakery_signup_fields_frontend', '', $rand_ids);
                    ...
                    <ul>
                        <li class="user-dashboard-menu-children">
                            ...
                            <?php if (($user_roles != '' && in_array("foodbakery_publisher", $user_roles))) {
                                $order_query = (isset( $_GET['order_id'] ) && $_GET['order_id'] > 0)? '&order_id='.$_GET['order_id'] : '';
                                ?>
                                <ul>
                                    <?php
                                    if ($publisher_profile_type != 'restaurant') {
                                        ...
                                        <li class="user_dashboard_ajax" id="foodbakery_publisher_orders" data-queryvar="dashboard=orders<?php echo $order_query; ?>"><a href="<?php echo ($this->foodbakery_dashboar_top_menu_url('dashboard=orders')); ?>"><i class="icon-add_shopping_cart"></i><?php echo esc_html__("My Orders", "foodbakery") ?></a></li>
