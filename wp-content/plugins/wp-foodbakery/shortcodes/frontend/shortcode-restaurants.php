...
//            }
            ...
            $element_filter_arr = apply_filters('foodbakery_restaurant_search_filters', $element_filter_arr);
            ...
            do_action('restaurants_element_frontend_before', $atts, $restaurant_loop_obj);
            ?>
