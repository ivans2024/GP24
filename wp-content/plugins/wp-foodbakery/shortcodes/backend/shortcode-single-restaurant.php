                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $foodbakery_opt_array = array(
                                ...
                                'desc' => '',
                                'hint_text' => __("Select Style View.", "foodbakery"),
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $single_restaurant_view,
                                    'id' => 'single_restaurant_view',
                                    'cust_name' => 'single_restaurant_view[]',
                                    'return' => true,
                                    'classes' => 'chosen-select',
                                    'options' => array(
    ...
    function foodbakery_save_page_builder_data_single_restaurant_callback($args)
    {
        ...
        if ($widget_type == "single_restaurant" || $widget_type == "cs_single_restaurant") {
            ...
            if (isset($data['foodbakery_widget_element_num'][$counters['foodbakery_counter']]) && $data['foodbakery_widget_element_num'][$counters['foodbakery_counter']] == 'shortcode') {
                ...
                if (isset($data['single_restaurant_view'][$counters['foodbakery_counter_single_restaurant']]) && $data['single_restaurant_view'][$counters['foodbakery_counter_single_restaurant']] != '') {
                    $foodbakery_bareber_single_restaurant .= 'single_restaurant_view="' . htmlspecialchars($data['single_restaurant_view'][$counters['foodbakery_counter_single_restaurant']], ENT_QUOTES) . '" ';
                }
