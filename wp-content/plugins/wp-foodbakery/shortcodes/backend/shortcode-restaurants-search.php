    ...
    function foodbakery_var_page_builder_restaurant_search($die = 0)
    {
        ...
        if (function_exists('foodbakery_shortcode_names')) {
            ...
            $defaults = array(
                ...
                'restaurant_search_show_location_field' => 'yes',
            );
		     ...
		     <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $foodbakery_counter) ?>"
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $foodbakery_opt_array = array(
                                'name' => esc_html__('Show Location Field', 'foodbakery'),
                                'desc' => '',
                                'hint_text' => '',
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($restaurant_search_show_location_field),
                                    'id' => 'restaurant_search_show_location_field',
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'restaurant_search_show_location_field[]',
                                    'return' => true,
                                    'options' => array(
                                        'yes' => 'Yes',
                                        'no' => 'No',
    ...
    function foodbakery_save_page_builder_data_restaurant_search_callback($args)
    {
        ...
        if ($widget_type == "restaurant_search" || $widget_type == "cs_restaurant_search") {
            ...
            if (isset($data['foodbakery_widget_element_num'][$counters['foodbakery_counter']]) && $data['foodbakery_widget_element_num'][$counters['foodbakery_counter']] == 'shortcode') {
                ...
                if (isset($data['restaurant_search_show_location_field'][$counters['foodbakery_counter_restaurant_search']]) && $data['restaurant_search_show_location_field'][$counters['foodbakery_counter_restaurant_search']] != '') {
                    $foodbakery_bareber_restaurant_search .= 'restaurant_search_show_location_field="' . htmlspecialchars($data['restaurant_search_show_location_field'][$counters['foodbakery_counter_restaurant_search']], ENT_QUOTES) . '" ';
                }
