...
function foodbakery_admin_add_menu_cat_to_list(menu_item_counter) {
	...
	$.ajax({
	    ...
	    method: "POST",
	    data: dataString,//'_menu_cat_title=' + menu_cat_title.val() + '&_menu_cat_desc=' + menu_cat_desc.val() + '&action=restaurant_add_menu_cat_item',
	    dataType: "json"
...
function foodbakery_add_menu_item_to_list(restaurant_counter, menu_item_counter, action, menu_item_counter_slideid) {
    console.log('foodbakery_add_menu_item_to_list');
  ...
  //  var serializedValues = jQuery('#foodbakery-dev-restaurant-form-' + restaurant_counter + '').serialize();
    ...
    var menu_item_stock = jQuery('#menu_item_stock_' + menu_item_counter).val();
	...
	if (action == 'edit' && restaurant_menu == current_restaurant_menu) {
	    jQuery('#add-menu-item-from-' + menu_item_counter_slideid).slideUp();
	} else {
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\
                <div class="row">\n\
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">\n\
                            <div class="field-holder">\n\
                                    <label>Image</label>\n\
                                    <div id="browse-btn-sec-'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'" class="browse-btn-sec" style="display:block !important">\n\
                                            ...
                                            <a id="browse-menu-icon-img-'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'" href="javascript:void(0)" class="browse-menu-icon-img btn bgcolor" data-id="'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'">Browse</a>\n\
                                    </div>\n\
                                    <div id="browse-img-sec-'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'" class="browse-image-sec" style="display:none !important">\n\
                                            <div class="icon-img-holder">\n\
                                                    ...
                                                    <img id="img-val-base-'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'" src="" alt=""  style="max-width:40px;">\n\
                                            </div>\n\
                                            <input id="hiden-img-val-'+menu_item_counter + count_extra_li+count_extra_inner_li_next+'" name="menu_item_extra[' + menu_item_counter + '][' + count_extra_li + '][image][]" value="" type="hidden">\n\
                                    </div>\n\
                            </div>\n\
                    </div>\n\
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">\n\
