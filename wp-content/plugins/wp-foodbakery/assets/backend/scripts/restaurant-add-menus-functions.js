...
function foodbakery_admin_add_menu_cat_to_list(menu_item_counter) {
    ...
    var dataString = '';
    $("#add-menu-cat-from-"+menu_item_counter).find("select, textarea, input").each(function() {
        if( jQuery(this).data('js_id') != 'undefined' && jQuery(this).val() != '' && jQuery(this).val() != null){
            dataString = dataString+jQuery(this).data('js_id')+'='+ jQuery(this).val()+'&';
        }
     });
    dataString  = dataString+'action=restaurant_add_menu_cat_item';
    ...
    if (menu_cat_title.val() != '') {
        $.ajax({
            ...
            method: "POST",
            data: dataString, //'_menu_cat_title=' + menu_cat_title.val() + '&_menu_cat_desc=' + menu_cat_desc.val() + '&action=restaurant_add_menu_cat_item1',
            dataType: "json"
...
function foodbakery_admin_add_menu_item_to_list(restaurant_counter, menu_item_counter, action) {
    ...
    var menu_item_calories = jQuery('#menu_item_calories_' + menu_item_counter).val();
...
function foodbakery_empty_fields_afet_add(restaurant_counter, menu_item_counter, action) {
    if (action == 'add') {
        ...
        jQuery('#menu_item_calories_' + menu_item_counter).val('');
...
function add_more_extra_option(restaurant_counter, menu_item_counter, title, price, currency_sign, count_extra_li, count_extra_inner_li, thisObj) {
    
    var total_length = jQuery(thisObj).closest('.menu-item-extra-block').find('.menu-item-extra-field').length;
    total_length    = parseInt(total_length) - 1;
    total_length    = (total_length < 0)? 0 : total_length;
    count_extra_inner_li = total_length;
    
    var count_extra_inner_li_next    = parseInt(count_extra_inner_li)+1;//count_extra_inner_li;
    var count_extra_inner_li_next_new    = count_extra_li+count_extra_inner_li_next;
    //jQuery('#menu-item-extra-fields-' + menu_item_counter + count_extra_li+count_extra_inner_li).closest('.row')
    jQuery(thisObj).closest('.menu-item-extra-fields').closest('.row').append('<ul id="menu-item-extra-fields-' + menu_item_counter + count_extra_li+count_extra_inner_li_next+'" class="menu-item-extra-fields"><li id="menu-item-extra-field-' + menu_item_counter + count_extra_li +count_extra_inner_li_next+ '" class="menu-item-extra-field">\n\
                    ...
                    <div class="row">\n\
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">\n\
                                    <div class="field-holder">\n\
                                            ...
                                            <input class="menu-item-extra-calories" id="menu_item_extra_calories_' + menu_item_counter + '" name="menu_item_extra[' + menu_item_counter + '][' + count_extra_li + '][calories][]" type="text" value="" placeholder="Calories">\n\
                                    </div>\n\
                            </div>\n\
                            <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">\n\
                                <div class="icon-image-browse-field" style="padding-top: 30px;">\n\
                                    <input id="foodbakery_extra_item_image_' + menu_item_counter + '_' + count_extra_inner_li_next_new + '_rand" name="menu_item_extra[' + menu_item_counter + '][' + count_extra_li + '][image][]" type="hidden" class="" value="">\n\
                                    <label style="display:block !important;" class="browse-icon">\n\
                                        <input name="foodbakery_extra_item_image_' + menu_item_counter + '_' + count_extra_inner_li_next_new + '_rand" type="button" class="cs-uploadMedia left" value="Browse">\n\
                                    </label>\n\
                                    <div class="page-wrap" style="display: none;" id="foodbakery_extra_item_image_' + menu_item_counter + '_' + count_extra_inner_li_next_new + '_rand_box">\n\
                                        <div class="gal-active">\n\
                                            <div class="dragareamain" style="padding-bottom:0px;">\n\
                                                <ul id="gal-sortable">\n\
                                                    <li class="ui-state-default" id="">\n\
                                                            <div class="thumb-secs"> <img src="" id="foodbakery_extra_item_image_' + menu_item_counter + '_' + count_extra_inner_li_next_new + '_rand_img" width="100" alt=""><div class="gal-edit-opts"><a href="javascript:del_media(\'foodbakery_extra_item_image_' + menu_item_counter + '_' + count_extra_inner_li_next_new + '_rand\')" class="delete"></a> </div></div>\n\
                                                    </li>\n\
                                                </ul>\n\
                                            </div>\n\
                                        </div>\n\
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">\n\
                                    <div class="menu-item-extra-options">\n\
											<label>&nbsp;</label>\n\
                                            <a href="javascript:void(0);" onClick="add_more_extra_option(\'' + restaurant_counter + '\',\'' + menu_item_counter + '\',\'' + title + '\',\'' + price + '\',\'' + currency_sign + '\',\'' + count_extra_li + '\',\'' + count_extra_inner_li_next + '\', this);">+</a>\n\
