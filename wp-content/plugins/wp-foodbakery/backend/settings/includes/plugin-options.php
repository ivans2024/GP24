...
if (!function_exists('foodbakery_settings_options_page')) {
    ...
    function foodbakery_settings_options_page() {
        ...
        $foodbakery_plugin_fields_func = apply_filters('foodbakery_plugin_fields_func', '');
        do_action('foodbakery_plugin_settings_page');
        $return = array('','');
        if (class_exists($foodbakery_plugin_fields_class)) {
            $obj = new $foodbakery_plugin_fields_class();
            $return = $obj->$foodbakery_plugin_fields_func($foodbakery_setting_options);
        }else{
            $return = apply_filters('foodbakery_verification_required_plugin_options', $return);
        }
...
//        );
        ...
        $foodbakery_setting_options = apply_filters('foodbakery_settings_after_api', $foodbakery_setting_options);
