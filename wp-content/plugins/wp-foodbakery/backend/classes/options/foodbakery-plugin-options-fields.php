<?php if (!class_exists('foodbakery8683bakery_options_fields')) {

    class foodbakery8683bakery_options_fields {
         ...
         */
        public function foodbakery8683bakery_fields($foodbakery_setting_options) {
