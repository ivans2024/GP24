...
if ( ! class_exists( 'Foodbakery_Publishers_Meta' ) ) {
    ...
    class Foodbakery_Publishers_Meta {
                        ...
                        <div class="elementhidden">
                            ...
                            <nav class="admin-navigtion">
                                <ul id="cs-options-tab">
                                    ...
                                    <li class="condition-fields individual-fields company-fields "><a href="javascript:void(0);" name="#tab-user-restaurants" href="javascript:;"><i class="icon-th-list"></i><?php _e( 'User Restaurants', 'foodbakery' ) ?> </a></li>
                                    <li class="condition-fields individual-fields company-fields "><a href="javascript:void(0);" name="#tab-orders-inquiries" href="javascript:;"><i class="icon-cart2"></i> <?php _e( 'Orders/Inquiries', 'foodbakery' ) ?></a></li>
                                  
                                    <li class="condition-fields individual-fields company-fields "><a href="javascript:void(0);" name="#tab-Searches22" href="javascript:;"><i class="icon-add_alert "></i> <?php _e( 'Searches & Alerts', 'foodbakery' ) ?></a></li>
                                    <?php
                                    if ( $publisher_profile_type == 'buyer' ) {
                                            ?>
                                            <li class="condition-fields individual-fields"><a href="javascript:void(0);" name="#tab-shortlists22" href="javascript:;"><i class="icon-favorite"></i> <?php _e( 'Shortlists', 'foodbakery' ) ?></a></li>
                                            <?php
                                    }
                                    ?>
                                    <li class="condition-fields individual-fields company-fields "><a href="javascript:void(0);" name="#tab-packages" href="javascript:;"><i class="icon-box"></i> <?php _e( 'Memberships', 'foodbakery' ) ?></a></li>
                                    <li style=" display: <?php echo esc_html( $display_tab ); ?>;" class="condition-fields company-fields publisher_company_name"><a href="javascript:void(0);" name="#tab-team-members" href="javascript:;"><i class="icon-users2"></i> <?php _e( 'Team Members', 'foodbakery' ) ?></a></li>
                                </ul>
                            </nav>
        ...
        function foodbakery_publishers_options() {
			...
			do_action('publisher_profile_type_backend', $publisher_profile_type, $post_id);
			
            echo '</div>
            </div>';
			
			
			do_action('publisher_profile_fields_backend', $post_id);

            echo '<div class="condition-fields company-fields publisher_company_name" style=" display: ' . $display_field . ';">';
            $foodbakery_opt_array = array(
