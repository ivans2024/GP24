                ...
                <div class="page-wrap page-opts left" style="overflow:hidden; position:relative;" id="locations_wrap" data-themeurl="<?php echo wp_foodbakery::plugin_url(); ?>" data-plugin_url="<?php echo wp_foodbakery::plugin_url(); ?>" data-ajaxurl="<?php echo esc_js(admin_url('admin-ajax.php'), 'foodbakery'); ?>" data-map_marker="<?php echo esc_html($foodbakery_map_marker_icon); ?>">
                    <div class="option-sec" style="margin-bottom:0;">
                        <div class="opt-conts">
                            ...
                            $output .= apply_filters('foodbakery_after_address_field_backend', '', $field_postfix, $post->ID);
                        ...
                        <div class="option-sec" style="margin-bottom:0;">
                            <div class="opt-conts">
                                ...
                                <div class="row">
                                    ...
                                    <?php echo do_action('foodbakery_after_address_field_frontend', $field_postfix, $post_id); 
                                    $lat_long_fields_class = apply_filters('foodbakery_lat_long_fields_class', '');
                                    ?>

                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 <?php echo $lat_long_fields_class; ?>">
                                        <div class="field-holder">
