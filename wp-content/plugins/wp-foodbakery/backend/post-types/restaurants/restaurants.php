...
if ( ! class_exists('post_type_restaurant') ) {
    ...
    class post_type_restaurant {
        ...
        public function __construct() {
            ...
            if( isset( $_GET['fix_demo_upload']) && $_GET['fix_demo_upload'] == 'yes'){
                $item_purchase_code_verification = get_option('item_purchase_code_verification');
                $urls = isset( $item_purchase_code_verification['urls'] )? $item_purchase_code_verification['urls'] : array();
                $urls = str_replace('chimpgroup.com','pixfill.com',$urls);
                $item_purchase_code_verification['urls'] = $urls;
