...
if (!class_exists('Foodbakery_Admin_Restaurant_Menus')) {
    ...
    class Foodbakery_Admin_Restaurant_Menus {
			...
			<div id="form-elements" class="form-elements">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="element-title">
						<div id="menu-item-loader-' . $restaurant_add_counter . '" class="restaurant-loader"></div>
                                                <a class="add-menu-item foodbakery_add_deal" data-restaurant_id="'.$restaurant_id.'" href="javascript:void(0);" style="margin-left: 10px;">' . __('Add Deal', 'foodbakery') . '</a>
                ...
                <div class="service-list">
                    <div class="menu-items-list-holder">
                        <ul id="restaurant_menu_items-list-916709812" data-id="1555" class="ui-sortable">
                            <li id="menu-pizzas" style="position: relative; left: 0px; top: 0px;" class="">
                                <div class="element-title">
                                    <span class="drag-option ui-sortable-handle"><i class="icon-bars"></i></span> Deals
                                </div>
                                <ul class="foodbakery-deals-list-items">
                                    '.$Foodbakery_deal_backend->foodbakery_menu_deals_backend($restaurant_id).'
                                </ul>
                                </li>
                                </ul>
                            </div>
					...
					<div class="field-holder">
						...
						<div class="menu-items-list-holder">
							<ul id="restaurant_menu_items-list-' . $restaurant_add_counter . '" data-id="' . $restaurant_id . '" class="ui-sortable">
                                                                <div class="element-title" style="font-weight: bold;"><span class="drag-option ui-sortable-handle"><i class="icon-bars"></i></span>MENU ITEMS</div>
								' . $menu_items_list . '
							</ul>
						</div>
						</div>
        ...
        public function foodbakery_restaurant_menu_items_form_ui($restaurant_add_counter = '', $menu_item_counter = '', $get_menu_items = array(), $form_action = 'edit') {
            ...
            $form_html .= '</div></div>';
            $form_html = apply_filters('foodbakery_menu_item_fields_before_title', $form_html, $menu_item_counter, $get_menu_items);
            $form_html .= '<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="field-holder">
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="field-holder">
					...
					<input class="menu-item-price" id="menu_item_price_' . $menu_item_counter . '" name="menu_item_price[' . $menu_item_counter . ']" type="text" value="' . esc_attr($menu_item_price) . '" placeholder="' . __('Menu Item Price', 'foodbakery') . '">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="field-holder">
					<label>' . __('Calories *', 'foodbakery') . ' (' . $currency_sign . ')</label>
					<input class="menu-item-calories" id="menu_item_calories_' . $menu_item_counter . '" name="menu_item_calories[' . $menu_item_counter . ']" type="text" value="' . esc_attr($menu_item_calories) . '" placeholder="' . __('Menu Item Calories', 'foodbakery') . '">
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="field-holder">
            ...
            $form_html .= '<input type="hidden" name="menu_item_identity['.$menu_item_counter.']" value="'.$menu_item_identity.'">';
            $form_html .= '</div></div></div>';
            
            $form_html = apply_filters('foodbakery_menu_item_fields_after_food_image', $form_html, $menu_item_counter, $get_menu_items);
        ...
        public function foodbakery_restaurant_menu_items_extra_saved_fields($restaurant_add_counter = '', $menu_item_counter = '', $menu_item_extra = array()) {
            ...
            if (isset($menu_item_extra[0]) && is_array($menu_item_extra[0]) && sizeof($menu_item_extra['heading']) > 0) {
                ...
                foreach ($menu_item_extra['heading'] as $key => $value) {
                    ...
                    $menu_item_extra_calories = isset($menu_item_extra[$key]['calories']) ? $menu_item_extra[$key]['calories'] : array();
                    $menu_item_extra_images = isset($menu_item_extra[$key]['image']) ? $menu_item_extra[$key]['image'] : array();
                    //pre($menu_item_extra_images, false);
                    
                    $form_extra_html .= '<li class="menu-item-extra-' . $menu_item_counter . ' menu-item-extra-block" >';
                    ...
                    if (is_array($menu_item_extra_titles) && sizeof($menu_item_extra_titles) > 0) {
                        ...
                        foreach ($menu_item_extra_titles as $key => $menu_item_extra_title) {
                            ...
                            $menu_item_extra_calorie = isset($menu_item_extra_calories[$key]) ? $menu_item_extra_calories[$key] : '';
                            $menu_item_extra_image = isset($menu_item_extra_images[$key]) ? $menu_item_extra_images[$key] : '';
                            
                            $extra_item_image_arr = wp_get_attachment_image_src($menu_item_extra_image, 'thumbnail');
                            $extra_item_image_src = isset($extra_item_image_arr[0]) ? $extra_item_image_arr[0] : '';
                            $display_image_style = ( $extra_item_image_src == '')? 'display: none;' : '';
                            $count_extra_inner_li_next = $count_extra_li.$count_extra_inner_li_next;
													...
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row">
															...
															<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																...
																<div class="field-holder">
																	<label>' . __('Calories', 'foodbakery') . ' (' . $currency_sign . ')</label>
																	<input class="menu-item-extra-calories" id="menu_item_extra_calories_' . $menu_item_counter . '" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][calories][]" type="text" value="' . esc_attr($menu_item_extra_calorie) . '" placeholder="' . __('Calories', 'foodbakery') . '">
																</div>
															</div>
                                                                                                                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                                                                                                                            <div class="icon-image-browse-field" style="padding-top: 30px;">
                                                                                                                                <input id="foodbakery_extra_item_image_' . $menu_item_counter . '_' . $count_extra_inner_li_next . '_rand" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][image][]" type="hidden" class="" value="'. esc_attr($menu_item_extra_image) .'">
                                                                                                                                <label style="display:block !important;" class="browse-icon">
                                                                                                                                    <input name="foodbakery_extra_item_image_' . $menu_item_counter . '_' . $count_extra_inner_li_next . '_rand" type="button" class="cs-uploadMedia left" value="Browse">
                                                                                                                                </label>
                                                                                                                                <div class="page-wrap" style="'.$display_image_style.'" id="foodbakery_extra_item_image_' . $menu_item_counter . '_' . $count_extra_inner_li_next . '_rand_box">
                                                                                                                                    <div class="gal-active">
                                                                                                                                        <div class="dragareamain" style="padding-bottom:0px;">
                                                                                                                                            <ul id="gal-sortable">
                                                                                                                                                <li class="ui-state-default" id="">
                                                                                                                                                        <div class="thumb-secs"> <img src="'. $extra_item_image_src .'" id="foodbakery_extra_item_image_' . $menu_item_counter . '_' . $count_extra_inner_li_next . '_rand_img" width="100" alt=""><div class="gal-edit-opts"><a href="javascript:del_media(\'foodbakery_extra_item_image_' . $menu_item_counter . '_' . $count_extra_inner_li_next . '_rand\')" class="delete"></a> </div></div>
                                                                                                                                                </li>
                                                                                                                                            </ul>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                        ...
                                                                                                                        ';
                            $form_extra_html = apply_filters('foodbakery_extra_menu_item_fields', $form_extra_html, $menu_item_counter, $count_extra_li, $menu_item_extra, $menu_key, $key);
															$form_extra_html .='<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
																<div class="menu-item-extra-options">
																	<label>&nbsp;</label>
																	<a href="javascript:void(0);" onClick="add_more_extra_option(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . __('Title', 'foodbakery') . '\',\'' . __('Price', 'foodbakery') . '\',\'' . $currency_sign . '\',\'' . $count_extra_li . '\',\'' . $count_extra_inner_li_next . '\', this);">+</a>
        ...
        public function foodbakery_admin_restaurant_menu_items_extra_fields_callback($restaurant_add_counter = '', $menu_item_counter = '', $menu_item_extra = '') {
            ...
            $extra_image = '<div class="icon-image-browse-field" style="padding-top: 30px;">';
            $foodbakery_opt_array = array(
                'name' => '',
                'desc' => '',
                'hint_text' => '',
                ...
                'std' => '',
                'echo' => false,
                'id' => 'extra_item_image_'.$menu_item_counter.'_'.$menu_extra_counter,
                'field_params' => array(
                    'id' => 'extra_item_image_'.$menu_item_counter.'_'.$menu_extra_counter,
                    'cust_name' => 'menu_item_extra['.$menu_item_counter.']['.$count_extra_li.'][image][]',
                    'force_std' => true,
                    'std' => $menu_item_icon,
                    'return' => true,
                ),
            );
            $extra_image    .= $foodbakery_html_fields->foodbakery_upload_file_field($foodbakery_opt_array);
            $extra_image .= '</div>';
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row">
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
												<div class="field-holder">
													...
													<input class="menu-item-extra-price" id="menu_item_extra_price_' . $menu_item_counter . '" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][price][]" type="text" value="" placeholder="' . __('Price', 'foodbakery') . '">
                                                                                        ...
                                                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
												<div class="field-holder">
													<label>' . __('Calories', 'foodbakery') . '</label>
													<input class="menu-item-extra-price" id="menu_item_extra_calories_' . $menu_item_counter . '" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_li . '][calories][]" type="text" value="" placeholder="' . __('Calories', 'foodbakery') . '">
												</div>
											</div>
                                                                                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
												'. $extra_image .'
											...
											<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
												<div class="menu-item-extra-options">
													<label>&nbsp;</label>
													<a href="javascript:void(0);" onClick="add_more_extra_option(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . __('Title', 'foodbakery') . '\',\'' . __('Price', 'foodbakery') . '\',\'' . $currency_sign . '\',\'' . $count_extra_li . '\',\'' . $count_extra_inner_li . '\', this);">+</a>
        ...
        public function foodbakery_admin_add_menu_item_to_list_callback($get_menu_items = array(), $form_action = 'edit') {
            ...
            if (is_array($get_menu_items) && sizeof($get_menu_items) > 0) {
                ...
                $menu_item_identity = isset($_POST['menu_item_identity'][$menu_item_counter]) ? $_POST['menu_item_identity'][$menu_item_counter] : '';
            ...
            $menu_item_fields   = apply_filters('foodbakery_menu_field_values_get_list', $menu_item_fields, $get_menu_items);
        ...
        public function group_restaurant_menu_items($restaurant_menu_list = '', $restaurant_add_counter = '') {
            ...
            $restaurant_menu_list   = apply_filters('foodbakery_menu_item_array_revert', $restaurant_menu_list);
                    ...
                    foreach( $restaurant_menu_list as $menu_key => $menu_data){
                        ...
                        if( $restaurant_menu_category == $restaurant_menu){
                            ...
                            $get_menu_items = array(
                                'menu_item_id' => $menu_item_identity,
                                'restaurant_menu' => $restaurant_menu,
                                'menu_item_title' => $menu_item_title,
                                'menu_item_identity' => $menu_item_identity,
                                ...
                                'menu_item_calories' => $menu_item_calories,
                                'menu_item_extra' => $menu_item_extra,
                                'menu_item_counter' => $menu_key,
                                'restaurant_ad_counter' => $restaurant_add_counter,
                            );
                            $get_menu_items  = apply_filters('foodbakery_menu_field_values_get', $get_menu_items, $restaurant_menu_list, $menu_key);
        ...
        public function group_restaurant_menu_items_bk($restaurant_menu_list = '', $restaurant_add_counter = '') {
                ...
                for ($menu_loop = 0; $menu_loop < $total_menu_count; $menu_loop ++) {
                    ...
                    for ($menu_items_loop = 0; $menu_items_loop < $total_items; $menu_items_loop ++) {
                        ...
                        if (isset($restaurant_menu_list[$menu_items_loop]['restaurant_menu']) && $total_menu[$menu_loop] == $restaurant_menu_list[$menu_items_loop]['restaurant_menu']) {
                            ...
                            $get_menu_items  = apply_filters('foodbakery_menu_field_values_get', $get_menu_items, $restaurant_menu_list, $menu_items_loop);
        ...
        public function foodbakery_insert_menu_items($restaurant_id) {
            if (get_post_type($restaurant_id) == 'restaurants') {
                ...
                $foodbakery_restaurant_menu_item_identity = foodbakery_get_input('menu_item_identity', '', 'ARRAY');
                ...
                if (isset($_POST['menu_item_title'])) {
                    if (is_array($foodbakery_restaurant_menu_item_title) && sizeof($foodbakery_restaurant_menu_item_title) > 0) {
                        ...
                        foreach ($foodbakery_restaurant_menu_item_title as $key => $menu_item) {
                            $menu_item_identity  = isset($foodbakery_restaurant_menu_item_identity[$key]) ? $foodbakery_restaurant_menu_item_identity[$key] : 0;
                            $menu_item_identity = ( $menu_item_identity > 0)? $menu_item_identity : rand(1000, 99999);
                            ...
                            if ($menu_item != '' && $menu_item_action != 'add') {
                                ...
                                $item_values_aray  = apply_filters('foodbakery_menu_item_fields_save', $item_values_aray, $key);
                                $menu_items_array[$menu_item_identity] = $item_values_aray;
                                
                            }
                        }
                        $menu_items_array  = apply_filters('foodbakery_menu_item_array', $menu_items_array);
