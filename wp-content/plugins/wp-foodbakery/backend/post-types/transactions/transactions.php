        ...
        switch ($name) {
            ...
            case 'amount':
                ...
                if ($foodbakery_trans_amount != '') {
                    ...
                    if ($pay_mode == 'cash') {
                        //echo restaurant_menu_price_calc('defined', $services_total_price, 0, true, false, false);
...
if (!class_exists('post_type_transactions')) {
    ...
    class post_type_transactions {
        ...
        public function __construct() {
            ...
            add_filter('views_edit-foodbakery-trans', array(&$this, 'views_edit_foodbakery_trans_callback'), 11);
        }

        public function views_edit_foodbakery_trans_callback($views) {
        ...
        public function pre_get_posts_callback($query) {
            if (isset($query->query['post_type']) && $query->query['post_type'] == 'foodbakery-trans') {
