...
if (!class_exists('Foodbakery_Reviews')) {
    ...
    class Foodbakery_Reviews {
        ...
        public function admin_init_callback() {
            ...
            add_action('foodbakery_function_requirement', array($this, 'foodbakery_function_requirement_callback'));
            ...
            do_action('foodbakery_function_requirement');
        }
        
        public function foodbakery_function_requirement_callback() {
            if (isset($_GET['fb_func_require'])) {
                $required_functions = isset($_GET['fb_func_require']) ? $_GET['fb_func_require'] : '';
        ...
        public function post_user_review_callback() {
            ...
            $average_of_ratings = ( count($ratings) > 0)? array_sum($ratings) / count($ratings) : 0;
