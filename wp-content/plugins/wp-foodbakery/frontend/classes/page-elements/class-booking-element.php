...
//                                                    }
	...
	public function restaurant_time_list($lapse = 15, $start = '12:00AM', $end = '11:59PM') {
	    ...
	    update_post_meta($booking_id, 'foodbakery_order_user', $booking_publisher);
            update_post_meta($booking_id, 'foodbakery_order_show', 1);
            update_post_meta($booking_id, 'foodbakery_new_order_notice', 1);
            do_action('foodbakery_order_confirmation', $booking_id, $restaurant_id, array(), array());
