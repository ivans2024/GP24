...
if (!class_exists('Foodbakery_Restaurant_Menus')) {
    ...
    class Foodbakery_Restaurant_Menus {
        ...
        public function __construct() {
            add_filter('foodbakery_restaurant_menu_items', array($this, 'foodbakery_restaurant_menu_items_callback'), 10, 5);
        ...
        public function restaurant_menu_add_icon_img_callback() {
            ...
            if (isset($image_file['name'])) {
                ...
                if (empty($status['error'])) {
                    ...
                    if( !isset( $status['file'] ) || empty( $status['file'] )){
        ...
        public function foodbakery_restaurant_menu_items_callback($restaurant_add_counter = '', $type_id = '', $foodbakery_id = '', $show_menu_items = true, $show_deals = true) {
            ...
            if ($get_restaurant_form_select_type != '') {
                ...
                $get_restaurant_form_menu_item_calories = foodbakery_get_input('menu_item_calories', '', 'ARRAY');
                $get_restaurant_form_menu_item_stock = foodbakery_get_input('menu_item_stock', '', 'ARRAY');
                    ...
                    foreach ($get_restaurant_form_menu_item_title as $menu_item_key => $menu_item) {
                        ...
                        if (count($menu_item) > 0) {
                            $form_menu_items_array[] = array(
                                ...
                                'menu_item_calories' => isset($get_restaurant_form_menu_item_calories[$menu_item_key]) ? $get_restaurant_form_menu_item_calories[$menu_item_key] : '',
                                'menu_item_stock' => isset($get_restaurant_form_menu_item_stock[$menu_item_key]) ? $get_restaurant_form_menu_item_stock[$menu_item_key] : '',
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="element-title">
						<h5>' . esc_html__('Deals', 'foodbakery') . '</h5>
						<div id="menu-item-loader-' . $restaurant_add_counter . '" class="restaurant-loader"></div>
                                                <a class="add-menu-item foodbakery_add_deal_frontend" data-restaurant_id="'.$get_restaurant_id.'" href="javascript:void(0);" style="margin-left: 10px;">' . __('Add Deal', 'foodbakery') . '</a>
					</div>
				</div>
                                <div class="foodbakery-deal-form"></div>
                                
                                <div class="foodbakery-deals-list">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="field-holder">
						<div class="service-list">
							<ul id="restaurant_menu_items-list-' . $restaurant_add_counter . '" class="restaurant_menu_items_cat_list panel-group">
                                                            <li id="menu-pizzas" class="panel panel-default"><div class="element-title panel-heading"><span class="drag-option ui-sortable-handle"><i class="icon-bars"></i></span> <a data-toggle="collapse">Deals</a></div>
                                                                

                                                            <ul class="foodbakery-deals-list-items menu-items-list">
                                                                
                                                                    '.$Foodbakery_deal_frontend->foodbakery_menu_deals_frontend($get_restaurant_id).'
                                                            </ul>
                                                        </li>
							</ul>
						</div>
			...
			<div class="row">
                ...
                $html .= '<div id="add-menu-item-from-' . $restaurant_add_counter . '" style="display:none;">';
                ...
                $html .= '</div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="field-holder">
                                        ...
                                        <div class="service-list">
                                                <ul id="restaurant_menu_items-list-' . $restaurant_add_counter . '" class="restaurant_menu_items_cat_list panel-group">
                                                    <div class="element-title panel-heading" style="margin-bottom: 5px;background: #f9f9f9;padding: 10px;font-weight: bold;"><span class="drag-option1" style="color: #999;font-size: 20px;margin: 2px 10px 0 0;vertical-align: middle;"><i class="icon-bars"></i></span> <a href="javascript:;">MENU ITEMS</a></div>
                                                        ' . $menu_items_list . '
                                                </ul>
                                        </div>
                                </div>
        ...
        public function foodbakery_restaurant_menu_items_form_ui($restaurant_add_counter = '', $menu_item_counter = '', $get_menu_items = array(), $form_action = 'edit') {
            ...
            $menu_item_calories = isset($get_menu_items['menu_item_calories']) ? $get_menu_items['menu_item_calories'] : '';
            ...
            $menu_item_counter_slideid = $menu_item_counter;
            $menu_item_counter = isset($get_menu_items['menu_item_identity']) ? $get_menu_items['menu_item_identity'] : $menu_item_counter;
            ...
            $form_html .= '
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
				<div class="field-holder">
					<label>' . esc_html__('Calories', 'foodbakery') . ' </label>';
            if ($form_action == 'add') {
                $form_html .= '<input class="menu-item-calories" id="menu_item_calories_' . $menu_item_counter . '" type="text" placeholder="' . esc_html__('Calories', 'foodbakery') . '">';
            } else {
                $form_html .= '<input class="menu-item-calories" id="menu_item_calories_' . $menu_item_counter . '" name="menu_item_calories[' . $menu_item_counter . ']" type="text" value="' . esc_attr($menu_item_calories) . '" placeholder="' . esc_html__('Calories', 'foodbakery') . '">';
            }
            $form_html .= '
				</div>
			</div>';
            ...
            do_action('foodbakery_stock_field_frontned', $restaurant_id, $get_menu_items, $menu_item_counter);

            $form_html .= ob_get_clean();
            
            $form_html .= '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="field-holder">
			...
			<div id="browse-img-sec-' . $menu_item_counter . '" class="browse-image-sec" style="display: ' . $browse_img_dis . ' !important;">
				<div class="icon-img-holder">
					...
					<img id="img-val-base-' . $menu_item_counter . '" src="' . $menu_item_icon_img_src . '" alt=""  style="max-width:40px;" />
				</div>
            ...
            ob_start();
            do_action('foodbakery_menu_item_fields_frontend', $restaurant_id, $get_menu_items, $menu_item_counter);
            $form_html .= ob_get_clean();
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="field-holder">
					...
					<a class="add-menu-item add-menu-item-list add-menu-item-list-' . $menu_item_counter . '" href="javascript:void(0);" onClick="foodbakery_add_menu_item_to_list(\'' . $restaurant_add_counter . '\',\'' . $menu_item_counter . '\',\'' . $action . '\',\'' . $menu_item_counter_slideid . '\');">' . $button_label . '</a>
				</div>
			</div>';
                ...
                foreach ($menu_item_extra['heading'] as $key => $value) {
                    ...
                    if (is_array($menu_item_extra_titles) && sizeof($menu_item_extra_titles) > 0) {
                        ...
                        foreach ($menu_item_extra_titles as $key => $menu_item_extra_title) {
                            ...
                            $menu_item_extra_image_arr = wp_get_attachment_image_src($menu_item_extra_image, 'thumbnail');
                            $menu_item_extra_image_src = isset($menu_item_extra_image_arr[0]) ? $menu_item_extra_image_arr[0] : '';
                            
                            $image_display = ( $menu_item_extra_image > 0)? 'display:block !important' : 'display:none !important';
                            $browse_display = ( $menu_item_extra_image > 0)? 'display:none !important' : 'display:block !important';
                            
                            $menu_item_extra_calories = isset($menu_item_extra_calories_array[$key]) ? $menu_item_extra_calories_array[$key] : '';
													...
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row">
															...
															<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
																...
																<div class="field-holder">
																	<label>' . esc_html__('Calories', 'foodbakery') . '</label>
																	<input class="menu-item-extra-calories" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_inner_li . '][calories][]" type="text" value="' . esc_attr($menu_item_extra_calories) . '" placeholder="' . esc_html__('Calories', 'foodbakery') . '">
																</div>
															</div>
                                                                                                                         <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                                                                                            <div class="field-holder">
                                                                                                                                <label>' . esc_html__('Image', 'foodbakery') . '</label>
                                                                                                                                <div id="browse-btn-sec-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" class="browse-btn-sec" style="'.$browse_display.'">
                                                                                                                                    <input type="file" id="image-icon-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" data-id="' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" name="image_icon_' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" class="browse-menu-icon-file" style="display: none;">
                                                                                                                                    <a id="browse-menu-icon-img-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" href="javascript:void(0)" class="browse-menu-icon-img btn bgcolor" data-id="' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '">' . esc_html__('Browse', 'foodbakery') . '</a>
                                                                                                                                </div>
                                                                                                                                <div id="browse-img-sec-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" class="browse-image-sec" style="'.$image_display.'">
                                                                                                                                    <div class="icon-img-holder">
                                                                                                                                        <a href="javascript:void(0)" data-id="' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" class="remove-icon"><i class="icon-close2"></i></a>
                                                                                                                                        <img id="img-val-base-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" src="'. $menu_item_extra_image_src .'" alt=""  style="max-width:40px;">
                                                                                                                                    </div>
                                                                                                                                    <input id="hiden-img-val-' . $menu_item_counter . $count_extra_li .$count_extra_inner_li_next . '" name="menu_item_extra[' . $menu_item_counter . '][' . $count_extra_inner_li . '][image][]" value="'. $menu_item_extra_image .'" type="hidden">
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
															<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        ...
        public function foodbakery_add_menu_item_to_list_callback($get_menu_items = '', $form_action = 'edit') {
            ...
            if (is_array($get_menu_items) && sizeof($get_menu_items) > 0) {
                ...
                $menu_item_price = isset($get_menu_items['menu_item_price']) ? $get_menu_items['menu_item_price'] : '';
                $menu_item_calories = isset($get_menu_items['menu_item_calories']) ? $get_menu_items['menu_item_calories'] : '';
                $menu_item_stock = isset($get_menu_items['menu_item_stock']) ? $get_menu_items['menu_item_stock'] : '';
                $menu_item_icon = isset($get_menu_items['menu_item_icon']) ? $get_menu_items['menu_item_icon'] : '';
                $menu_item_nutri = isset($get_menu_items['menu_item_nutri']) ? $get_menu_items['menu_item_nutri'] : '';
                ...
                $menu_item_identity = isset($get_menu_items['menu_item_identity']) ? $get_menu_items['menu_item_identity'] : '';
                ...
                if (isset($_POST['menu_item_title']) && isset($_POST['menu_item_price']) && !is_array($_POST['menu_item_title'])) {
                    ...
                    $menu_item_calories = isset($_POST['menu_item_calories']) ? $_POST['menu_item_calories'] : '';
                    $menu_item_stock = isset($_POST['menu_item_stock']) ? $_POST['menu_item_stock'] : '';
                    ...
                    $menu_item_calories = isset($_POST['menu_item_calories'][$menu_item_counter]) ? $_POST['menu_item_calories'][$menu_item_counter] : '';
                    $menu_item_stock = isset($_POST['menu_item_stock'][$menu_item_counter]) ? $_POST['menu_item_stock'][$menu_item_counter] : '';
            ...
            $menu_item_fields   = apply_filters('foodbakery_menu_item_fields_array', $menu_item_fields, $get_menu_items);
        ...
        public function group_restaurant_menu_items($restaurant_menu_list = '', $restaurant_add_counter = '') {
            ...
            if (is_array($restaurant_menu_list) && sizeof($restaurant_menu_list) > 0) {
                ...
                foreach ($total_menu as $total_menu_key => $total_menu_data) {
                    ...
                    $menu_items_list .= '<span class="drag-option ui-sortable-handle"><i class="icon-bars"></i></span> <a data-toggle="collapse"' . $colapse_head_class . ' data-parent="#restaurant_menu_items-list-' . $restaurant_add_counter . '" href="#collapse-' . $total_menu_key . '">' . $restaurant_menu . '</a>';
                    $menu_items_list .= '</div>';
                    $menu_items_list .= '
					<div id="collapse-' . $total_menu_key . '" class="' . $colapse_class . '">';
                    ...
                    foreach( $restaurant_menu_list as $menu_key => $menu_data){
                        ...
                        if( $restaurant_menu_category == $restaurant_menu){
                            ...
                            $menu_item_stock = isset($menu_data['menu_item_stock']) ? $menu_data['menu_item_stock'] : '';
                            $menu_item_extra = isset($menu_data['menu_item_extra']) ? $menu_data['menu_item_extra'] : '';
                            $menu_item_counter = isset($menu_data['menu_item_counter']) ? $menu_data['menu_item_counter'] : '';
                            ...
                            $menu_items_list .= $this->foodbakery_add_menu_item_to_list_callback(apply_filters('foodbakery_menu_items_array', $get_menu_items, $menu_data), 'edit');
                        }
                    }
                    $menu_items_list .= '</ul>';
                    $menu_items_list .= '</div>';
