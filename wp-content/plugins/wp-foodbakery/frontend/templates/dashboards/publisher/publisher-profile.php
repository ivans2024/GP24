...
if ( ! class_exists( 'Foodbakery_Publisher_Profile' ) ) {
    ...
    class Foodbakery_Publisher_Profile {
        ...
        public function publisher_change_address_call_back($is_exit = true) {
            ...
            update_post_meta( $company_id, 'foodbakery_array_data', $_POST );
            if ( $company_id != '' ) {
        ...
        public function foodbakery_publisher_accounts_save() {
            ...
            $this->publisher_change_address_call_back(false);
