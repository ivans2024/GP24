                    ...
                    while ($order_query->have_posts()) : $order_query->the_post();
                        ...
                        if ($publisher_type == 'restaurant') {
                            ...
                            <li class="order-heading-titles">
                                ...
                                <div>
                                    <?php
                                    $numeric_order_price = is_numeric($order_price) ? $order_price : 0;
                                    $numeric_amount_charged_ = is_numeric($amount_charged_) ? $amount_charged_ : 0;
                                    $received = foodbakery_get_currency(($numeric_order_price - $numeric_amount_charged_), true, '', '', false);
                                    echo $received;
                                    ?>
                                </div>
