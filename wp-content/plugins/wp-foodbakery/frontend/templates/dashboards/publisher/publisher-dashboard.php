                                                    ...
                                                    <div class="user-account-nav user-account-sidebar">
                                                        ...
                                                        <div class="user-nav-list">
                                                            <ul>
                                                                ...
                                                                if ($publisher_profile_type == 'individual' || $publisher_profile_type == 'buyer') {
                                                                    ...
                                                                    ?>
                                                                    <li class="user_dashboard_ajax" id="foodbakery_publisher_orders" data-queryvar="dashboard=orders<?php echo $order_query; ?>"><a href="javascript:void(0);" class="btn-edit-profile"><i class="icon-add_shopping_cart"></i><?php echo esc_html__('My Orders', 'foodbakery'); ?></a></li>
                                                                    <?php
