...
class Foodbakery_Restaurants_Frontend{
    ...
    public function render($settings) {
        ...
        $a = shortcode_atts($defaults, $settings);
        ...
        $qrystr .= apply_filters('jobhunt_search_query_string_callback', '');
...
//                echo '</pre>';
                ...
                if ($a['cs_job_searchbox'] == 'yes') {
                    ...
                    include('jobs/jobs-searchbox.php');
                }
                // do_action('liamdemoncuit_job_style_call',$a,$args);
                // job view load
                if ($a['cs_job_view'] == 'advance') {
                    include('jobs/views/cs_advance.php');
                }
                if ($a['cs_job_view'] == 'modernv1') {
                    include('jobs/views/cs_modernv1.php');
                }
                if ($a['cs_job_view'] == 'modernv2') {
                    include('jobs/views/cs_modrenv2.php');
                }
                if ($a['cs_job_view'] == 'modernv3') {
                    include('jobs/views/cs_modrenv3.php');
                }
                if ($a['cs_job_view'] == 'simple') { // duplicate
                    include('jobs/views/cs_simple.php');
                }

                if ($a['cs_job_view'] == 'grid') {
                    include('jobs/views/cs_grid.php');
                }
                if ($a['cs_job_view'] == 'boxed') {
                    include('jobs/views/cs_boxed.php');
                }
                if ($a['cs_job_view'] == 'detail') {
                    include('jobs/views/cs_detail.php');
                }
                if ($a['cs_job_view'] == 'modren') {
                    include('jobs/views/cs_modren.php');
                }
                if ($a['cs_job_view'] == 'grid_classic') {
                    include('jobs/views/cs_grid_classic.php');
                }
                if ($a['cs_job_view'] == 'grid_slider') {
                    include('jobs/views/cs_grid_slider.php');
                }
                if ($a['cs_job_view'] == 'fancy') {
                    include('jobs/views/cs_fancy.php');
                }
                if ($a['cs_job_view'] == 'classic') {
                    include('jobs/views/cs_classic.php');
                }// end job views
                if ($a['cs_job_view'] == 'modernv4') {

                    include('jobs/views/cs_modernv4.php');
                }
                if ($a['cs_job_view'] == 'aviation') {

                    include('jobs/views/cs_aviation.php');
                }
                if ($a['cs_job_searchbox'] == 'yes') {
                    echo '</div>';
                    echo '</div>';
