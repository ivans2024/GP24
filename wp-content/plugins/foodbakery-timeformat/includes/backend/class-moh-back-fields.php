...
if (!class_exists('class_moh_back_fields')) {

    class class_moh_back_fields {
        ...
        function __construct() {
            ...
            add_filter('foodbakery_restaurant_save_opening_hours', array($this, 'foodbakery_restaurant_save_opening_hours_callback'), 10, 3);
        ...
        public function wp_multi_opening_hour_fields_backend_callback($day_key, $get_opening_hours, $time_list, $empty_return = '') {
